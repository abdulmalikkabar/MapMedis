...
import com.stmik.ayuprima.ayuprima.adapter.CustomAdapterHospita;
...
public class ActivityHospital extends AppCompatActivity implements LocationListener, SwipeRefreshLayout.OnRefreshListener,
        SearchView.OnQueryTextListener {

    SwipeRefreshLayout swipe;
    ListView list;
    CustomAdapterHospita adapter;
    ProgressDialog pDialog;
    List<Hospital> itemList = new ArrayList<>();
   ...
   //private static final String url = "http://192.168.43.8/MapMedis/json/json_hospital.php?lat=";
    //private static final String url = "http://192.168.43.8/MapMedis/json/json_hospital.php?lat=";
    private static final String url = "https://mapmedisgo.000webhostapp.com/json/json_hospital.php?lat=";
    public static final String url_cari = "https://mapmedisgo.000webhostapp.com/json/cari_hospital.php?lat=-6.894796&lng=110.638413";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new CustomAdapterHospita(this, itemList);
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            try {
                                ...
                                m.setNama(obj.getString("nama_rs"));
    ...
    private void cariData(final String keyword) {
        pDialog = new ProgressDialog(ActivityHospital.this);
                    ...
                    if (value == 1) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                           ...
                           data.setKet(obj.getString(TAG_KET));
                            ...
                            String ket = String.valueOf(obj.getString(TAG_KET));
