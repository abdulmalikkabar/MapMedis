...
import com.stmik.ayuprima.ayuprima.adapter.CustomAdapterApotik;
...
public class ActivityApotik extends AppCompatActivity implements  LocationListener, SwipeRefreshLayout.OnRefreshListener,
    ...
    ListView list;
    CustomAdapterApotik adapter;
    List<Apotik> itemList = new ArrayList<>();
    ...
    //private static final String url = "http://192.168.43.8/MapMedis/json/json_apotik.php?lat=";
    //  private static final String url = "http://192.168.43.8/FasilitasPariwisata/json/json_rm.php?lat=";
    private static final String url = "https://mapmedisgo.000webhostapp.com/json/json_apotik.php?lat=";
    // private static final String url = "http://10.0.2.2/MapMedis/json/json_hospital.php?lat=";
    public static final String url_cari = "https://mapmedisgo.000webhostapp.com/json/cari_apotik.php?lat=-6.894796&lng=110.638413";
    private static final String TAG = ActivityHospital.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new CustomAdapterApotik(this, itemList);
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            try {
                                ...
                                m.setNm_apotik(obj.getString("nm_apotik"));
                                m.setAlamat(obj.getString("alamat"));
                                m.setKet(obj.getString("ket"));
                                m.setTelpon(obj.getString("telpon"));
                                m.setGambar(obj.getString("gambar"));
                                m.setGambar1(obj.getString("gambar1"));
                                m.setGambar2(obj.getString("gambar2"));
    ...
    private void cariData(final String keyword) {
        pDialog = new ProgressDialog(ActivityApotik.this);
                ...
                try {
                    ...
                    if (value == 1) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            Apotik data = new Apotik();

                            data.setId_apotik(obj.getString(TAG_ID));
                            data.setNm_apotik(obj.getString(TAG_NAMA));
                            ...
                            data.setTelpon(obj.getString(TAG_TELPON));
